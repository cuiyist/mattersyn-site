...
import {enhanceRecordChemicals} from './chemical-viewer.mjs?v=0.26.0-r1';
import {mountEvidence, mountCrystalReferences} from './material-guide.mjs?v=0.26.0-r1';
